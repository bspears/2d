(function() {
  ...
  function updateGame() {
    ...
    for(enemy in thisLevel.enemies){
      ...
      baseCol    = Math.floor(thisEnemy.XPos/tileSize);
      baseRow    = Math.floor(thisEnemy.YPos/tileSize);
      colOverlap = thisEnemy.XPos%tileSize;
      rowOverlap = thisEnemy.YPos%tileSize;
